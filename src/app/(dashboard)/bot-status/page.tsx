...
const QUEUE1_CONFIG = [
  ...
  { name: "Height & Safety Company Targeter", dcmType: "Height & Safety Company Targeter" },
  { name: "Consultancy New DCM", dcmType: "Consultancy New" },
];
...
const QUEUE2_CONFIG = [
  ...
  { name: "Fire Alarm DCM", dcmType: "Fire Alarm" },
      ...
      try {
        ...
        const processQueue = (config: typeof QUEUE1_CONFIG) => {
          const processed = config.map(bot => {
            ...
            const isUpdatedToday = dbLastUpdated >= startOfTodayMs;
            ...
            return {
              ...
              status,
              timeLabel: "",
              lastTimestamp: effectiveLatestTs,
              earliestTs: effectiveEarliestTs
            };
          });
