...
const dcmNavItems = [
  ...
  { title: "Fire Alarm DCM", href: "/candidates?dcmType=Fire+Alarm", icon: Flame },
...
const companyTargetingNavItems = [
  ...
  { title: "Large Companies Targeter", href: "/candidates?dcmType=Large+Companies+Targeter", icon: Target },
];
